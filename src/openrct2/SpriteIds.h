...
enum : ImageIndex
{
    ...
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_LEFT_BANKED
        + 20,
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_END = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_LEFT,
    SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_MINI_RC_END = SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_BM_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_BM_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_BM_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_BM_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_BM_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_BM_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_BM_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_BM_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_BM_RC_END = SPR_TRACKS_BM_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_BM_INVERT_FLAT = SPR_TRACKS_BM_INVERT_DIAG_BRAKES + 2,
    SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE = SPR_TRACKS_BM_INVERT_FLAT + 2,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_FLAT = SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE + 4,
    SPR_TRACKS_BM_INVERT_GENTLE = SPR_TRACKS_BM_INVERT_GENTLE_TO_FLAT + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_STEEP = SPR_TRACKS_BM_INVERT_GENTLE + 4,
    SPR_TRACKS_BM_INVERT_STEEP_TO_GENTLE = SPR_TRACKS_BM_INVERT_GENTLE_TO_STEEP + 6,
    SPR_TRACKS_BM_INVERT_STEEP = SPR_TRACKS_BM_INVERT_STEEP_TO_GENTLE + 6,
    SPR_TRACKS_BM_INVERT_STEEP_TO_VERTICAL = SPR_TRACKS_BM_INVERT_STEEP + 4,
    SPR_TRACKS_BM_INVERT_VERTICAL_TO_STEEP = SPR_TRACKS_BM_INVERT_STEEP_TO_VERTICAL + 4,
    SPR_TRACKS_BM_INVERT_VERTICAL = SPR_TRACKS_BM_INVERT_VERTICAL_TO_STEEP + 4,
    SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT = SPR_TRACKS_BM_INVERT_VERTICAL + 4,
    SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT = SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT + 12,
    SPR_TRACKS_BM_INVERT_LARGE_TURN_LEFT = SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT + 20,
    SPR_TRACKS_BM_INVERT_LARGE_TURN_RIGHT = SPR_TRACKS_BM_INVERT_LARGE_TURN_LEFT + 16,
    SPR_TRACKS_BM_INVERT_FLAT_DIAG = SPR_TRACKS_BM_INVERT_LARGE_TURN_RIGHT + 16,
    SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE_DIAG = SPR_TRACKS_BM_INVERT_FLAT_DIAG + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_FLAT_DIAG = SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE_DIAG + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_DIAG = SPR_TRACKS_BM_INVERT_GENTLE_TO_FLAT_DIAG + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_STEEP_DIAG = SPR_TRACKS_BM_INVERT_GENTLE_DIAG + 4,
    SPR_TRACKS_BM_INVERT_STEEP_TO_GENTLE_DIAG = SPR_TRACKS_BM_INVERT_GENTLE_TO_STEEP_DIAG + 4,
    SPR_TRACKS_BM_INVERT_STEEP_DIAG = SPR_TRACKS_BM_INVERT_STEEP_TO_GENTLE_DIAG + 4,
    SPR_TRACKS_BM_INVERT_FLAT_TO_LEFT_BANK = SPR_TRACKS_BM_INVERT_STEEP_DIAG + 4,
    SPR_TRACKS_BM_INVERT_FLAT_TO_RIGHT_BANK = SPR_TRACKS_BM_INVERT_FLAT_TO_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_LEFT_BANK_TO_GENTLE = SPR_TRACKS_BM_INVERT_FLAT_TO_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_RIGHT_BANK_TO_GENTLE = SPR_TRACKS_BM_INVERT_LEFT_BANK_TO_GENTLE + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_LEFT_BANK = SPR_TRACKS_BM_INVERT_RIGHT_BANK_TO_GENTLE + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_RIGHT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_TO_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_LEFT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_TO_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_FLAT_TO_LEFT_BANK_DIAG = SPR_TRACKS_BM_INVERT_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_FLAT_TO_RIGHT_BANK_DIAG = SPR_TRACKS_BM_INVERT_FLAT_TO_LEFT_BANK_DIAG + 4,
    SPR_TRACKS_BM_INVERT_LEFT_BANK_TO_GENTLE_DIAG = SPR_TRACKS_BM_INVERT_FLAT_TO_RIGHT_BANK_DIAG + 4,
    SPR_TRACKS_BM_INVERT_RIGHT_BANK_TO_GENTLE_DIAG = SPR_TRACKS_BM_INVERT_LEFT_BANK_TO_GENTLE_DIAG + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_LEFT_BANK_DIAG = SPR_TRACKS_BM_INVERT_RIGHT_BANK_TO_GENTLE_DIAG + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_RIGHT_BANK_DIAG = SPR_TRACKS_BM_INVERT_GENTLE_TO_LEFT_BANK_DIAG + 4,
    SPR_TRACKS_BM_INVERT_LEFT_BANK_DIAG = SPR_TRACKS_BM_INVERT_GENTLE_TO_RIGHT_BANK_DIAG + 4,
    SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT_BANK = SPR_TRACKS_BM_INVERT_LEFT_BANK_DIAG + 4,
    SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT_BANK = SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT_BANK + 12,
    SPR_TRACKS_BM_INVERT_LARGE_TURN_LEFT_TO_DIAG_BANK = SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT_BANK + 20,
    SPR_TRACKS_BM_INVERT_LARGE_TURN_RIGHT_TO_DIAG_BANK = SPR_TRACKS_BM_INVERT_LARGE_TURN_LEFT_TO_DIAG_BANK + 16,
    SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT_GENTLE = SPR_TRACKS_BM_INVERT_LARGE_TURN_RIGHT_TO_DIAG_BANK + 16,
    SPR_TRACKS_BM_INVERT_SMALL_TURN_RIGHT_GENTLE = SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT_GENTLE + 8,
    SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT_GENTLE = SPR_TRACKS_BM_INVERT_SMALL_TURN_RIGHT_GENTLE + 8,
    SPR_TRACKS_BM_INVERT_MEDIUM_TURN_RIGHT_GENTLE = SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT_GENTLE + 20,
    SPR_TRACKS_BM_INVERT_VERY_SMALL_TURN_LEFT_STEEP = SPR_TRACKS_BM_INVERT_MEDIUM_TURN_RIGHT_GENTLE + 20,
    SPR_TRACKS_BM_INVERT_VERY_SMALL_TURN_RIGHT_STEEP = SPR_TRACKS_BM_INVERT_VERY_SMALL_TURN_LEFT_STEEP + 8,
    SPR_TRACKS_BM_INVERT_VERTICAL_TWIST_LEFT = SPR_TRACKS_BM_INVERT_VERY_SMALL_TURN_RIGHT_STEEP + 8,
    SPR_TRACKS_BM_INVERT_VERTICAL_TWIST_RIGHT = SPR_TRACKS_BM_INVERT_VERTICAL_TWIST_LEFT + 7,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_GENTLE_LEFT_BANK = SPR_TRACKS_BM_INVERT_VERTICAL_TWIST_RIGHT + 7,
    SPR_TRACKS_BM_INVERT_GENTLE_TO_GENTLE_RIGHT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_TO_GENTLE_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK_TO_GENTLE = SPR_TRACKS_BM_INVERT_GENTLE_TO_GENTLE_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK_TO_GENTLE = SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK_TO_GENTLE + 4,
    SPR_TRACKS_BM_INVERT_LEFT_BANK_TO_GENTLE_LEFT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK_TO_GENTLE + 4,
    SPR_TRACKS_BM_INVERT_RIGHT_BANK_TO_GENTLE_RIGHT_BANK = SPR_TRACKS_BM_INVERT_LEFT_BANK_TO_GENTLE_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK_TO_LEFT_BANK = SPR_TRACKS_BM_INVERT_RIGHT_BANK_TO_GENTLE_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK_TO_RIGHT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK_TO_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK_TO_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE_LEFT_BANK = SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE_RIGHT_BANK = SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE_LEFT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK_TO_FLAT = SPR_TRACKS_BM_INVERT_FLAT_TO_GENTLE_RIGHT_BANK + 4,
    SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK_TO_FLAT = SPR_TRACKS_BM_INVERT_GENTLE_LEFT_BANK_TO_FLAT + 4,
    SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT_BANK_GENTLE = SPR_TRACKS_BM_INVERT_GENTLE_RIGHT_BANK_TO_FLAT + 4,
    SPR_TRACKS_BM_INVERT_SMALL_TURN_RIGHT_BANK_GENTLE = SPR_TRACKS_BM_INVERT_SMALL_TURN_LEFT_BANK_GENTLE + 8,
    SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT_BANK_GENTLE = SPR_TRACKS_BM_INVERT_SMALL_TURN_RIGHT_BANK_GENTLE + 8,
    SPR_TRACKS_BM_INVERT_MEDIUM_TURN_RIGHT_BANK_GENTLE = SPR_TRACKS_BM_INVERT_MEDIUM_TURN_LEFT_BANK_GENTLE + 20,
    SPR_TRACKS_BM_INVERT_S_BEND_LEFT = SPR_TRACKS_BM_INVERT_MEDIUM_TURN_RIGHT_BANK_GENTLE + 20,
    SPR_TRACKS_BM_INVERT_S_BEND_RIGHT = SPR_TRACKS_BM_INVERT_S_BEND_LEFT + 8,
    SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_LEFT = SPR_TRACKS_BM_INVERT_S_BEND_RIGHT + 8,
    SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_RIGHT = SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_LEFT_BANK = SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_RIGHT_BANK = SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_LEFT_BANK + 20,
    SPR_TRACKS_BM_INVERT_INLINE_TWIST_LEFT = SPR_TRACKS_BM_INVERT_MEDIUM_QUARTER_HELIX_RIGHT_BANK + 20,
    SPR_TRACKS_BM_INVERT_INLINE_TWIST_RIGHT = SPR_TRACKS_BM_INVERT_INLINE_TWIST_LEFT + 12,
    SPR_TRACKS_BM_INVERT_HALF_LOOP = SPR_TRACKS_BM_INVERT_INLINE_TWIST_RIGHT + 12,
    SPR_TRACKS_BM_INVERT_VERTICAL_LOOP_LEFT = SPR_TRACKS_BM_INVERT_HALF_LOOP + 16,
    SPR_TRACKS_BM_INVERT_VERTICAL_LOOP_RIGHT = SPR_TRACKS_BM_INVERT_VERTICAL_LOOP_LEFT + 16,
    SPR_TRACKS_BM_INVERT_CORKSCREW_LEFT = SPR_TRACKS_BM_INVERT_VERTICAL_LOOP_RIGHT + 16,
    SPR_TRACKS_BM_INVERT_CORKSCREW_RIGHT = SPR_TRACKS_BM_INVERT_CORKSCREW_LEFT + 12,
    SPR_TRACKS_BM_INVERT_LARGE_HALF_LOOP_LEFT = SPR_TRACKS_BM_INVERT_CORKSCREW_RIGHT + 12,
    SPR_TRACKS_BM_INVERT_LARGE_HALF_LOOP_RIGHT = SPR_TRACKS_BM_INVERT_LARGE_HALF_LOOP_LEFT + 28,
    SPR_TRACKS_BM_INVERT_RC_END = SPR_TRACKS_BM_INVERT_LARGE_HALF_LOOP_RIGHT + 28,
    ...
    SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_STANDUP_TRACK_LARGE_ZERO_G_ROLL + 42,
    SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_STANDUP_RC_END = SPR_TRACKS_STANDUP_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_STEEPLECHASE_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_STEEPLECHASE_DIAG_BRAKES + 2,
    SPR_TRACKS_STEEPLECHASE_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_STEEPLECHASE_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_STEEPLECHASE_RC_END = SPR_TRACKS_STEEPLECHASE_TRACK_QUARTER_HELIX_RIGHT + 20,
    ...
    SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_MULTIDIM_INVERTED_DIAG_BRAKES + 5,
    SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_MULTIDIM_RC_END = SPR_TRACKS_MULTIDIM_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_CORKSCREW_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_CORKSCREW_RC_END = SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_LIM_LAUNCHED_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_LIM_LAUNCHED_TRACK_END = SPR_TRACKS_LIM_LAUNCHED_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_LEFT,
    SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_MINE_RIDE_END = SPR_TRACKS_MINE_RIDE_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE_BANKED + 142,
    SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_LEFT + 21,
    SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_RIGHT + 21,
    SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_LEFT_BANKED + 26,
    SPR_TRACKS_HYBRID_LIFT_BEGIN = SPR_TRACKS_HYBRID_TRACK_QUARTER_HELIX_RIGHT_BANKED + 26,
    ...
    SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_SINGLE_RAIL_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_LEFT_BANKED + 20,
    SPR_TRACKS_SINGLE_RAIL_LIFT_BEGIN = SPR_TRACKS_SINGLE_RAIL_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    ...
    SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_ALPINE_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_LEFT_BANKED + 21,
    SPR_TRACKS_ALPINE_LIFT_BEGIN = SPR_TRACKS_ALPINE_TRACK_QUARTER_HELIX_RIGHT_BANKED + 21,

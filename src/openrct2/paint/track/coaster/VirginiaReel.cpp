...
static constexpr TrackPaintFunction kVirginiaReelTrackPaintFunctions[] = {
...
static_assert(std::size(kVirginiaReelTrackPaintFunctions) == EnumValue(TrackElemType::Count));
...
{
    return kVirginiaReelTrackPaintFunctions[EnumValue(trackType)];
}

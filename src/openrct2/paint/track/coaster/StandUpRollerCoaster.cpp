...
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthToDiagUp25SupportHeightExtras = { { { 10, 8, 6, 6 }, {}, {}, {}, { 7, 7, 3, 5 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthToDiagUp25SupportHeightExtras = { { { 6, 6, 8, 10 }, {}, {}, {}, { 5, 3, 7, 7 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthToOrthogonalUp25SupportHeightExtras = { { { 8, 8, 6, 7 }, {}, {}, {}, { 7, 7, 7, 4 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthToOrthogonalUp25SupportHeightExtras = { { { 6, 8, 8, 7 }, {}, {}, {}, { 7, 7, 7, 7 } } };

static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToDiagUp25SupportHeightExtras = { { { 6, 7, 9, 12 }, {}, {}, {}, { 1, 7, 7, 8 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToDiagUp25SupportHeightExtras = { { { 12, 9, 7, 6 }, {}, {}, {}, { 8, 7, 6, 1 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToOrthogonalUp25SupportHeightExtras = { { { 7, 7, 9, 8 }, {}, {}, {}, { 5, 6, 8, 11 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToOrthogonalUp25SupportHeightExtras = { { { 9, 7, 8, 8 }, {}, {}, {}, { 8, 7, 7, 10 } } };
    ...
    switch (trackType)
    {
        ...
        case TrackElemType::leftEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE,
        ...
        case TrackElemType::rightEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE + 16,
        ...
        case TrackElemType::leftEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE + 48,
        ...
        case TrackElemType::rightEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE + 32,
        ...
        case TrackElemType::leftEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE_BANKED + 64,
        ...
        case TrackElemType::rightEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE_BANKED + 80,
        ...
        case TrackElemType::leftEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE_BANKED + 112,
        ...
        case TrackElemType::rightEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_STANDUP_TRACK_GENTLE_LARGE_CURVE_BANKED + 96,

...
#include "../../track_pieces/LargeTurnGentle.h"
...
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthToDiagUp25SupportHeightExtras = { { { 6, 6, 6, 6 }, {}, {}, {}, { 12, 5, 3, 3 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthToDiagUp25SupportHeightExtras = { { { 6, 6, 6, 6 }, {}, {}, {}, { 3, 3, 5, 10 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthToOrthogonalUp25SupportHeightExtras = { { { 7, 5, 5, 4 }, {}, {}, {}, { 5, 5, 5, 5 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthToOrthogonalUp25SupportHeightExtras = { { { 5, 5, 7, 4 }, {}, {}, {}, { 5, 5, 5, 5 } } };

static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToDiagUp25SupportHeightExtras = { { { 5, 7, 9, 12 }, {}, {}, {}, { 7, 6, 7, 8 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToDiagUp25SupportHeightExtras = { { { 12, 9, 7, 5 }, {}, {}, {}, { 8, 7, 6, 7 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToOrthogonalUp25SupportHeightExtras = { { { 7, 8, 9, 4 }, {}, {}, {}, { 6, 6, 8, 11 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToOrthogonalUp25SupportHeightExtras = { { { 9, 7, 7, 3 }, {}, {}, {}, { 8, 6, 6, 11 } } };
...
TrackPaintFunction GetTrackPaintFunctionCorkscrewRC(TrackElemType trackType)
{
    switch (trackType)
    {
        ...
        case TrackElemType::leftEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE,
                kLeftEighthToDiagUp25SpriteMap, kLeftEighthToDiagUp25BoundingBoxes, false,
                kLeftEighthToDiagUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, false, false>;
        case TrackElemType::rightEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE + 16,
                kRightEighthToDiagUp25SpriteMap, kRightEighthToDiagUp25BoundingBoxes, false,
                kRightEighthToDiagUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, false, false>;
        case TrackElemType::leftEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE + 48,
                kRightEighthToOrthogonalUp25SpriteMap, kRightEighthToOrthogonalUp25BoundingBoxes, false,
                kRightEighthToOrthogonalUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, true, false>;
        case TrackElemType::rightEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE + 32,
                kLeftEighthToOrthogonalUp25SpriteMap, kLeftEighthToOrthogonalUp25BoundingBoxes, false,
                kLeftEighthToOrthogonalUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, true, false>;
        ...
        case TrackElemType::leftEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE_BANKED + 64,
                kLeftEighthToDiagUp25SpriteMap, kLeftEighthBankToDiagUp25BoundingBoxes, false,
                kLeftEighthBankToDiagUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, false, false>;
        case TrackElemType::rightEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE_BANKED + 80,
                kRightEighthToDiagUp25SpriteMap, kRightEighthBankToDiagUp25BoundingBoxes, false,
                kRightEighthBankToDiagUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, false, false>;
        case TrackElemType::leftEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE_BANKED + 112,
                kRightEighthToOrthogonalUp25SpriteMap, kRightEighthBankToOrthogonalUp25BoundingBoxes, false,
                kRightEighthBankToOrthogonalUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, true, false>;
        case TrackElemType::rightEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_CORKSCREW_TRACK_GENTLE_LARGE_CURVE_BANKED + 96,
                kLeftEighthToOrthogonalUp25SpriteMap, kLeftEighthBankToOrthogonalUp25BoundingBoxes, false,
                kLeftEighthBankToOrthogonalUp25SupportHeightExtras, BlockedSegmentsType::narrow, kTunnelGroup,
                TrackMetadata::SequenceTunnelType::upright, 1, 24, true, false>;
        ...
        case TrackElemType::leftQuarterHelixLargeUp:
            return OpenRCT2::trackPaintLeftQuarterHelixLargeUp<
                SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_LEFT, OpenRCT2::kLeftQuarterHelixLargeUpSpriteMap, false,
        ...
        case TrackElemType::rightQuarterHelixLargeUp:
            return OpenRCT2::trackPaintRightQuarterHelixLargeUp<
                SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT, OpenRCT2::kRightQuarterHelixLargeUpSpriteMap, false,
        ...
        case TrackElemType::leftQuarterBankedHelixLargeUp:
            return OpenRCT2::trackPaintLeftQuarterBankedHelixLargeUp<
                SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_LEFT_BANKED, OpenRCT2::kLeftQuarterBankedHelixLargeUpSpriteMap, false,
        ...
        case TrackElemType::rightQuarterBankedHelixLargeUp:
            return OpenRCT2::trackPaintRightQuarterBankedHelixLargeUp<
                SPR_TRACKS_CORKSCREW_TRACK_QUARTER_HELIX_RIGHT_BANKED, OpenRCT2::kRightQuarterBankedHelixLargeUpSpriteMap,

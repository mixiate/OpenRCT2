...
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthToDiagUp25SupportHeightExtras = { { { 6, 6, 6, 6 }, {}, {}, {}, { 2, 3, 2, 1 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthToDiagUp25SupportHeightExtras = { { { 6, 6, 6, 6 }, {}, {}, {}, { 1, 2, 3, 2 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthToOrthogonalUp25SupportHeightExtras = { { { 5, 5, 3, 4 }, {}, {}, {}, { 4, 4, 4, 4 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthToOrthogonalUp25SupportHeightExtras = { { { 3, 5, 5, 4 }, {}, {}, {}, { 4, 4, 4, 4 } } };

static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToDiagUp25SupportHeightExtras = { { { 0, 6, 9, 12 }, {}, {}, {}, { 1, 4, 7, 7 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToDiagUp25SupportHeightExtras = { { { 12, 9, 6, 0 }, {}, {}, {}, { 7, 7, 4, 1 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToOrthogonalUp25SupportHeightExtras = { { { 5, 7, 9, 8 }, {}, {}, {}, { 3, 3, 8, 9 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToOrthogonalUp25SupportHeightExtras = { { { 9, 7, 5, 8 }, {}, {}, {}, { 8, 3, 3, 9 } } };
    ...
    switch (trackType)
    {
        ...
        case TrackElemType::leftEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE, kLeftEighthToDiagUp25SpriteMap,
                kLeftEighthToDiagUp25BoundingBoxes, false, kLeftEighthToDiagUp25SupportHeightExtras,
                BlockedSegmentsType::narrow, kTunnelGroup, TrackMetadata::SequenceTunnelType::upright, 1, 24, false, false>;
        case TrackElemType::rightEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE + 16,
        ...
        case TrackElemType::leftEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE + 48,
        ...
        case TrackElemType::rightEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE + 32,
        ...
        case TrackElemType::rightEighthToOrthogonalDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE, kLeftEighthToDiagUp25SpriteMap,
                kLeftEighthToDiagUp25BoundingBoxes, false, kLeftEighthToDiagUp25SupportHeightExtras,
                BlockedSegmentsType::narrow, kTunnelGroup, TrackMetadata::SequenceTunnelType::upright, 1, 24, true, false>;
        ...
        case TrackElemType::leftEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE_BANKED + 64,
        ...
        case TrackElemType::rightEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE_BANKED + 80,
        ...
        case TrackElemType::leftEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE_BANKED + 112,
        ...
        case TrackElemType::rightEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_BM_TRACK_GENTLE_LARGE_CURVE_BANKED + 96,

...
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToDiagUp25SupportHeightExtras = { { { 0, 6, 9, 12 }, {}, {}, {}, { 7, 4, 7, 7 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToDiagUp25SupportHeightExtras = { { { 12, 9, 6, 0 }, {}, {}, {}, { 7, 7, 4, 7 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kLeftEighthBankToOrthogonalUp25SupportHeightExtras = { { { 5, 7, 9, 7 }, {}, {}, {}, { 0, 3, 8, 9 } } };
static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
    kRightEighthBankToOrthogonalUp25SupportHeightExtras = { { { 9, 7, 5, 7 }, {}, {}, {}, { 8, 3, 0, 9 } } };
    ...
    switch (trackType)
    {
        ...
        case TrackElemType::leftEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE,
        ...
        case TrackElemType::rightEighthToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE + 16,
        ...
        case TrackElemType::leftEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE + 48,
        ...
        case TrackElemType::rightEighthToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE + 32,
        ...
        case TrackElemType::leftEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE_BANKED + 64,
        ...
        case TrackElemType::rightEighthBankToDiagUp25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE_BANKED + 80,
        ...
        case TrackElemType::leftEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE_BANKED + 112,
        ...
        case TrackElemType::rightEighthBankToDiagDown25:
            return trackPaintGeneric<
                kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_LATTICE_TRIANGLE_TRACK_GENTLE_LARGE_CURVE_BANKED + 96,

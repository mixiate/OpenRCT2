...
namespace OpenRCT2::HybridRC
{
    ...
    static constexpr std::array<std::array<int8_t, kNumOrthogonalDirections>, kLargeTurnGentleSequenceCount>
        kLargeTurnGentleSupportHeightExtras{};
        ...
        switch (trackType)
        {
            ...
            case TrackElemType::leftEighthToDiagUp25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE,
                    kLeftEighthToDiagUp25SpriteMap, kLeftEighthToDiagUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, false, true>;
            case TrackElemType::rightEighthToDiagUp25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE + 16,
                    kRightEighthToDiagUp25SpriteMap, kRightEighthToDiagUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, false, true>;
            case TrackElemType::leftEighthToDiagDown25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 2, 1, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE + 48,
                    kRightEighthToOrthogonalUp25SpriteMapHybrid, kRightEighthToOrthogonalUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, true, true>;
            case TrackElemType::rightEighthToDiagDown25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 2, 1, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE + 32,
                    kLeftEighthToOrthogonalUp25SpriteMapHybrid, kLeftEighthToOrthogonalUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, true, true>;
            ...
            case TrackElemType::leftEighthBankToDiagUp25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE_BANKED + 70,
                    kLeftEighthToDiagUp25SpriteMap, kLeftEighthBankToDiagUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, false, true>;
            case TrackElemType::rightEighthBankToDiagUp25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 1, 1, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE_BANKED + 86,
                    kRightEighthToDiagUp25SpriteMap, kRightEighthBankToDiagUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, false, true>;
            case TrackElemType::leftEighthBankToDiagDown25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 2, 2, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE_BANKED + 122,
                    kRightEighthBankToOrthogonalUp25SpriteMapHybrid, kRightEighthToOrthogonalUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, true, true>;
            case TrackElemType::rightEighthBankToDiagDown25:
                return trackPaintGeneric<
                    kLargeTurnGentleSequenceCount, 2, 2, SPR_TRACKS_HYBRID_TRACK_GENTLE_LARGE_CURVE_BANKED + 102,
                    kLeftEighthBankToOrthogonalUp25SpriteMapHybrid, kLeftEighthToOrthogonalUp25BoundingBoxesHybrid, true,
                    kLargeTurnGentleSupportHeightExtras, BlockedSegmentsType::wide, kTunnelGroup,
                    TrackMetadata::SequenceTunnelType::upright, 1, 24, true, true>;

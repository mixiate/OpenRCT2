...
enum : ImageIndex
{
    ...
    SPR_G2_CORKSCREW_TRACK_VERTICAL = SPR_G2_CORKSCREW_DIAG_BRAKES + 6,
    SPR_G2_CORKSCREW_TRACK_VERTICAL_TWIST = SPR_G2_CORKSCREW_TRACK_VERTICAL + 12,
    SPR_G2_CORKSCREW_TRACK_LARGE_CORKSCREW = SPR_G2_CORKSCREW_TRACK_VERTICAL_TWIST + 12,
    SPR_G2_CORKSCREW_TRACK_MEDIUM_HALF_LOOP = SPR_G2_CORKSCREW_TRACK_LARGE_CORKSCREW + 42,
    SPR_G2_CORKSCREW_TRACK_LARGE_HALF_LOOP = SPR_G2_CORKSCREW_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_G2_CORKSCREW_RC_END = SPR_G2_CORKSCREW_TRACK_LARGE_HALF_LOOP + 56,
